...
Route::prefix('category_toppings')->group(function () {
...
Route::prefix('staffs')->group(function () {
    ...
    Route::get('/permission', [StaffController::class, 'table_permission'])->name('staff.permission');
...
Route::prefix('departments')->group(function () {
    ...
    Route::get('/table_permission', [DepartmentController::class, 'table_permission'])->name('department.permission');
});
