...
@section('style')
    ...
    <link href="{{asset('user/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css"/>
                        ...
                        <div class="mt-5">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="user/assets/media/svg/brand-logos/plurk.svg" class="h-50"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                            ...
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="user/assets/media/svg/brand-logos/figma-1.svg" class="h-50"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="user/assets/media/svg/brand-logos/vimeo.svg" class="h-50"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                ...
                <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
                    <div class="col-xl-3 mb-5 mb-xl-0">
                        ...
                        <div class="card h-150px bgi-no-repeat bgi-size-cover bgi-position-y-center card-xl-stretch"
                            style="background-image:url('user/assets/media/stock/600x600/img-22.jpg')">
                            <!--begin::Body-->
                            <div class="card-body p-6">
                                <!--begin::Title-->
                                <a href="#" class="text-black text-hover-primary fw-bold fs-2"
                                    data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Company</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Body-->
                        </div>
                ...
                <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card h-175px bgi-no-repeat bgi-size-contain card-xl-stretch mb-5 mb-xl-8"
                            style="background-color: #663259; background-position: right; background-image:url('user/assets/media/svg/misc/taieri.svg')">
                            <!--begin::Body-->
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <!--begin::Action-->
                                <div class="m-0">
                                    <a href='#' class="btn btn-danger fw-semibold px-6 py-3"
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card h-100 bgi-no-repeat bgi-size-cover card-xl-stretch mb-5 mb-xl-8"
                            style="background-image:url('user/assets/media/misc/bg-2.jpg')">
                            <!--begin::Body-->
                            <div class="card-body d-flex flex-column justify-content-between">
                                <!--begin::Title-->
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" multiple="multiple"
                                                ...
                                                data-dropdown-parent="#kt_menu_64b779fc5e58c" data-allow-clear="true">
                                                <option></option>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="user/assets/media/avatars/300-5.jpg" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="user/assets/media/avatars/300-20.jpg" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                        ...
                                        <td>
                                            <a href="#"
                                                class="text-dark fw-bold text-hover-primary d-block fs-6">The Hill</a>
                                            <span
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="user/assets/media/avatars/300-23.jpg" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                    ...
                    <div class="card-body pt-2">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <img src="user/assets/media/avatars/300-6.jpg" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="user/assets/media/avatars/300-5.jpg" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="user/assets/media/avatars/300-11.jpg" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="user/assets/media/avatars/300-9.jpg" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="user/assets/media/avatars/300-23.jpg" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="user/assets/media/svg/brand-logos/plurk.svg"
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="user/assets/media/svg/brand-logos/telegram.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="user/assets/media/svg/brand-logos/vimeo.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="user/assets/media/svg/brand-logos/bebo.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="user/assets/media/svg/brand-logos/kickstarter.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
...
@section('script')
    ...
    <script src="{{asset('user/assets/js/custom/utilities/modals/create-campaign.js')}}"></script>
