...
@section('content')
    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
        ...
        <div class="content flex-row-fluid" id="kt_content">
            <div class="d-flex justify-content-between py-5">
                <div class="">
                    <h1 class="d-flex text-white fw-bold my-1 fs-3">Quản lý nhà cung cấp</h1>
                    ...
                    <table class="table align-middle table-bordered fs-6 gy-5">
                        <thead class="bg-primary">
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="">Tên</th>
                                <th class="w-200px">Điện thoại</th>
    ...
    @include('User.supplier.modal_add')
    <div class="modal fade" id="modal-edit" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <form action="{{ route('supplier.update') }}" id="form-update" method="POST" enctype="multipart/form-data">
...
@section('script')
    <script>
        const routeList = "{{ route('supplier.list') }}";
        const routeUpdate = "{{ route('supplier.update') }}";
        filterTable();
        ...
        function confirmDelete(id) {
            deleteData(id, "{{ route('supplier.delete') }}");
        }

        function changeStatus(id) {
            $.post("{{ route('supplier.update') }}", {
                id
            }, function(rs) {
                Toast.fire({
                    icon: rs?.type,
