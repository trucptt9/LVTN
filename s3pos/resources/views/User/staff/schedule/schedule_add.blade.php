                                      ...
                                      <div class="row">
                                          <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                              ...
                                              <input type="text" class="form-control form-control-solid"
                                                  placeholder="Nhập tên ca làm" name="name" value="" />
                                          </div>

                                          <div class=" col-md-6 d-flex flex-column mb-7 fv-row">
                                              <!--begin::Label-->
                                              <label class="fs-6 fw-semibold form-label mb-2">Mã ca</label>
                                              <!--end::Label-->
                                              <!--begin::Input wrapper-->
                                              <div class="position-relative">
                                                  <!--begin::Input-->
                                                  <input type="text" class="form-control form-control-solid"
                                                      placeholder="Nhập mã hoặc mã tự sinh" name="code"
                                                      value="" />
                                                  <!--end::Input-->
                                                  <!--begin::Card logos-->
                                      ...
                                      <div class="row">
                                          <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                              ...
                                              <input class="form-control form-control-solid flatpickr-input active"
                                                  ...
                                                  id="start_modal_add_schedule_datepicker" type="text"
                                                  readonly="readonly">
                                          </div>
                                          ...
                                          <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            ...
                                            <input class="form-control form-control-solid flatpickr-input active"
                                                placeholder="Pick date &amp; time" name="event_datetime"
                                                id="end_modal_add_schedule_datepicker" type="text"
                                                readonly="readonly">
                                        </div>
                                      </div>
