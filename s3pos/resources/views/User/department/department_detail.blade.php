        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            <div class="page-title d-flex flex-column me-3">
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    ...
                    <h6 class="breadcrumb-item text-white opacity-75">Quản lý phòng ban</h6>
                    <h6 class="breadcrumb-item">
                        <span class="bullet bg-white opacity-75 w-5px h-2px"></span>
                    </h6>
                    <h6 class="breadcrumb-item text-white opacity-75">Chi tiết phòng ban</h6>
                </ul>
            </div>
        </div>
                ...
                <div class="flex-column flex-lg-row-auto w-lg-250px w-xl-350px mb-10">
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Summary-->
                            <h3 class="fw-bold mt-5">Thông tin phòng ban</h3>
                            <!--begin::Details content-->
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">

                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">Tên phòng ban</div>
                                    <div class="text-gray-600">
                                        <span class="text-gray-600 text-hover-primary">Quản lý</span>
                                    </div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">Mã phòng ban</div>
                                    <div class="text-gray-600">QL-A
                                    </div>
                                    <!--begin::Details item-->
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4 active fs-6" data-bs-toggle="tab"
                                href="#info_account">Cập nhật phòng ban</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                                ...
                                <div class="card-body pt-0 pb-5">
                                    <div class="d-flex">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid w-50"
                                            name="name" value="Quản lý" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="d-flex mt-3">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2 mt-2 w-200px">
                                            <span class="">Mã phòng ban</span>

                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-lg form-control-solid w-50"
                                            name="code" placeholder="Username" value="QL-A" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="d-flex mt-3">
                                        <!--begin::Label-->
