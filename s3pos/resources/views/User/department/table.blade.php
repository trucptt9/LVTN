...
<thead>
    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
        ...
        <th class="min-w-125px">Tên phòng ban</th>
        <th class="min-w-125px">Mã phòng ban</th>
        
        <th class="min-w-150px">Mô tả</th>
        <th class="w-90px text-center">Trạng thái</th>
        <th class="w-70px text-center">#</th>
        <th class="text-end w-70px text-center">#</th>
    </tr>
</thead>
<tbody class="text-gray-600 fw-semibold">
    <tr>
        ...
        <td class="text-center">
            <a href="{{ route('departments.detail') }}">
