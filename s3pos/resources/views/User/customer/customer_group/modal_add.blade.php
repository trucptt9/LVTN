  ...
  <div class="modal fade" id="modal_add_customer_group" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
                                ...
                                <div class="w-100">
                                    <div class="row">
                                        <div
                                            ...
                                            <label
                                                ...
                                                <span class="required">Tên thẻ</span>
                                                <span class="ms-1"
                                    ...
                                    <div class="row">
                                        <div
                                            ...
                                            <label
                                                class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                                                <span class="required">Thấp nhất (điểm thấp nhất)</span>
                                                <span class="ms-1"
                                                    data-bs-toggle="tooltip"
                                                    title="Specify a card holder's name">
                                                    <i
                                        ...
                                        <div
                                            ...
                                            <!--begin::Label-->
                                            <label
                                                class="fs-6 fw-semibold form-label mb-2 required">Cao nhất (điểm cao nhất)</label>
                                            <!--end::Label-->
                                            <!--begin::Input wrapper-->
                                            <div class="position-relative">
                                                <!--begin::Input-->
