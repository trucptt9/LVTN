...
<div class="card">
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <!--end::Modal - New Card-->
            @include('user.customer.customer_group.modal_add')
        </div>
        <!--end::Card toolbar-->
    </div>
    <!--end::Card header-->
    ...
    <div class=" card-body py-4">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5"
            id="kt_table_customer_group">

            <thead>
                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                  
                    <th class="min-w-125px">Tên thẻ</th>
                    <th class="min-w-125px">Mã thẻ</th>
                    <th class="min-w-75px">Thấp nhất</th>
                    <th class="min-w-75px">Cao nhất</th>
                    <th class="min-w-150px">Mô tả</th>
                    <th class="min-w-50px text-center">Trạng thái</th>
                    <th class="text-end min-w-70px text-center">#</th>
                </tr>
            </thead>
            <tbody class="text-gray-600 fw-semibold customer_group_table">
