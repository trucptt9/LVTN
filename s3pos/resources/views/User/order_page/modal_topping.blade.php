                      ...
                      <div class="flex-row-fluid py-lg-5">
                          <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                              <div class="d-flex align-items-center position-relative my-1 mb-5">
                                  <select class="form-select mb-2 w-100" data-placeholder="Select an option">
                                          ...
                                          <div class="card-body"
                                              ...
                                              <div class="mb-2 ">
                                                  ...
                                                  <div class="" style="display: flex; align-items:center">
                                                      <a href="#" class="">
                                                          <i class="ki-duotone ki-message-minus fs-2hx text-success">
                                                              <span class="path1"></span>
                                                              <span class="path2"></span>
                                                          </i>
                                                      </a>
                                                      <span style="padding-left: 5px; padding-right:5px"
                                                          class="fw-bold fs-5"> 0 </span>
                                                      <a href="#" class="">
                                      ...
                                      <div class="card card-flush flex-row-fluid pb-5 w-160px h-200px">
                                          ...
                                          <div class="card-body"
                                              ...
                                              <div class="mb-2 ">
                                                  <!--begin::Title-->
                                                  <div class="text-start fw-bold text-gray-800 cursor-pointer text-hover-primary fs-6"
                                                      style="overflow: hidden;text-overflow: ellipsis">Trân châu -
                                                      <span class="text-success text-end fw-bold fs-5">24.000 đ</span>
