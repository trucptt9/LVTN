    ...
    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
        ...
        <div class="content flex-row-fluid" id="kt_content">
            <div class="d-flex justify-content-between py-5">
                <div class="">
                    <h1 class="d-flex text-white fw-bold my-1 fs-3">Danh mục topping</h1>
            ...
            <div class="modal-dialog modal-dialog-centered mw-600px">
                <div class="modal-content">
                    <div class="modal-header">
                        <!--begin::Modal title-->
                        <h2>Cập nhật danh mục topping</h2>
...
@section('script')
    <script>
        const routeList = "{{ route('topping_category.list') }}";
        // const routeUpdate = "{{ route('topping_category.update') }}";
        filterTable();
        ...
        function confirmDelete(id) {
            deleteData(id, "{{ route('topping_category.delete') }}");
        }

        function changeStatus(id) {
            $.post("{{ route('topping_category.update') }}", {
                id
            }, function(rs) {
                Toast.fire({
                    icon: rs?.type,
