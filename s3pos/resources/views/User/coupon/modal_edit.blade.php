    ...
    <div class="stepper-nav ps-lg-10">
        ...
        <div class="fv-row mb-2" style="display: flex; align-items:center">
            <div class="">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="number" class="form-control form-control-lg form-control-solid" name="value"
...
<div class="col-6">
    ...
    <div class="stepper-nav ps-lg-10">
        <div class="fv-row mb-2">
            ...
            <input class="form-control form-control-solid" placeholder="Chọn ngày" name="start" id="coupon_day_start1"
        ...
        <div class="fv-row mb-2">
            ...
            <!--end::Label-->
            <input class="form-control form-control-solid" placeholder="Chọn ngày" name="end" id="coupon_day_end2"
