       ...
       <div class="modal-dialog modal-dialog-centered mw-650px">
           ...
           <div class="modal-content">
               ...
               <div class="modal-header" id="kt_modal_add_user_header">
                   <!--begin::Modal title-->
                   <h2 class="fw-bold">Thêm phương thức thanh toán</h2>
                   <!--end::Modal title-->
                   <!--begin::Close-->
               ...
               <div class="modal-body my-5">
                   <!--begin::Form-->
                   <form class="form" action="{{ route('method_payment.insert') }}" id="form-create" method="POST"
                           ...
                           <div class="row">
                               <div class="col-md-6">
                                   <div class="fv-row mb-7">
                                       ...
                                       <!--end::Label-->
                                       <!--begin::Input-->
                                       <input type="text" name="description" class="form-control mb-3 mb-lg-0"
