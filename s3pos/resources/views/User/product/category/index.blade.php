        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <h6 class="breadcrumb-item text-white opacity-75">Danh mục món </h6>
                    <!--end::Item-->
                        ...
                        <div class="card">
                            ...
                            <div class="card-header border-0 pt-6">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    @include('user.product.category.modal_add')
                                </div>
                                <!--end::Card toolbar-->
                            </div>
                            <!--end::Card header-->
                            ...
                            <div class=" card-body py-4">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                    ...
                                    <tbody class="text-gray-600 fw-semibold category_table">
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            function loadData() {
                $.get("{{ route('category.table') }}", function(res) {
            ...
            $('.add_category').click(function(e) {
                e.preventDefault();
                $('#modal_add_category').trigger('reset');
