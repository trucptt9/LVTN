...
@section('style')
    ...
    <link href="user/assets/plugins/custom/vis-timeline/vis-timeline.bundle.css" rel="stylesheet" type="text/css" />
                            ...
                            <ul class="nav nav-pills nav-pills-custom mb-3">
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
                                        ...
                                        <div class="nav-icon">
                                            <img alt=""
                                                src="user/assets/media/svg/products-categories/t-shirt.svg"
                                                class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="user/assets/media/svg/products-categories/gaming.svg"
                                                class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="user/assets/media/svg/products-categories/watch.svg"
                                                class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="user/assets/media/svg/products-categories/gloves.svg"
                                                class="nav-icon" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <!--begin::Icon-->
                                        <div class="nav-icon">
                                            <img alt="" src="user/assets/media/svg/products-categories/shoes.svg"
                                                class="nav-icon" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/210.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/215.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/209.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/197.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/178.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/22.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/1.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/24.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/71.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/41.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/63.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/59.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/10.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/96.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="user/assets/media/stock/ecommerce/13.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    <img src="user/assets/media/svg/illustrations/easy/2.svg"
                                        class="theme-light-show w-200px" alt="" />
                                    <img src="user/assets/media/svg/illustrations/easy/2-dark.svg"
                            ...
                            <div class="text-center mb-1">
                                ...
                                <a class="btn btn-sm btn-primary me-2"
                                    href="../../demo2/dist/apps/ecommerce/sales/listing.html">View App</a>
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light"
                                    href="../../demo2/dist/apps/ecommerce/catalog/add-product.html">New Product</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                        </div>
                                        ...
                                        <td colspan="2">
                                            <div class="d-flex align-items-center gap-3">
                                                <a href="#"
                                                    ...
                                                    <img src=""
                                                        data-kt-src-path="user/assets/media/stock/ecommerce/"
                            ...
                            <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="user/assets/media/stock/ecommerce/210.png" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="user/assets/media/stock/ecommerce/209.png" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="user/assets/media/stock/ecommerce/214.png" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="user/assets/media/stock/ecommerce/211.png"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="user/assets/media/stock/ecommerce/192.png"
                                                class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="../../demo2/dist/apps/ecommerce/catalog/edit-product.html"
...
@section('script')
    ...
    <script src="user/assets/plugins/custom/vis-timeline/vis-timeline.bundle.js"></script>
