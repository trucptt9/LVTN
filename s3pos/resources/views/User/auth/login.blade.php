...
<html lang="en">
	...
	<body id="kt_body" class="auth-bg bgi-size-cover bgi-attachment-fixed bgi-position-center">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('user/assets/media/auth/bg10.jpeg'); } [data-bs-theme="dark"] body { background-image: url('user/assets/media/auth/bg10-dark.jpeg'); }</style>
			<!--end::Page bg image-->
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-lg-row-fluid">
					...
					<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
						<!--begin::Image-->
						<img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="user/assets/media/auth/agency.png" alt="" />
						<img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="user/assets/media/auth/agency-dark.png" alt="" />
						<!--end::Image-->
							...
							<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
								...
								<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo2/dist/index.html" action="#">
									...
									<div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
										<div></div>
										<!--begin::Link-->
										<a href="../../demo2/dist/authentication/layouts/overlay/reset-password.html" class="link-primary">Quên mật khẩu ?</a>
										<!--end::Link-->
									</div>
									<!--end::Wrapper-->
									<!--begin::Submit button-->
		...
		<script src="user/assets/js/custom/authentication/sign-in/general.js"></script>
