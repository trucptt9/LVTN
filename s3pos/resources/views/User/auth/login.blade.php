                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo2/dist/index.html" action="#">
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Email-->
                                    <input type="text" placeholder="abx@gmail.com" name="email" autocomplete="off" class="form-control bg-transparent" />
                                    <!--end::Email-->
                                </div>
                                <!--end::Input group=-->
                                ...
                                <a href="../../demo2/dist/authentication/layouts/overlay/sign-up.html" class="link-primary">Sign up</a></div>
                                <!--end::Sign up--> --}}
                            </form>
                            <!--end::Form-->
                        </div>
