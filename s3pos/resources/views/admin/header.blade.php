            ...
            <div class="topbar d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                        ...
                        <div class="row g-0">
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="../../demo2/dist/apps/projects/budget.html"
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="../../demo2/dist/apps/projects/settings.html"
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="../../demo2/dist/apps/projects/list.html"
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="../../demo2/dist/apps/projects/users.html"
                ...
                <div class="d-flex align-items-center me-lg-n2 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="btn btn-icon btn-active-light-primary btn-custom w-30px h-30px w-md-40px h-md-40px"
                        data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                        data-kt-menu-placement="bottom-end">
                        <img class="h-30px w-30px rounded" src="admin/assets/media/avatars/300-2.jpg"
                            alt="" />
                    </div>
                                ...
                                <span class="menu-title position-relative">Language
                                    <span
                                        ...
                                        <img class="w-15px h-15px rounded-1 ms-2"
                                            src="admin/assets/media/flags/united-states.svg"
                                            alt="" /></span></span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
